...
}(this, (function (e)
{
	...
	class w extends h
	{
		constructor(e, t, i)
		{
			super(e, t), this.mfa_token = i, Object.setPrototypeOf(this, w.prototype)
		}
	}
	class y extends h
	{
	...
	const b = () => window.crypto,
		...
		I = e =>
		{
			...
			return new URLSearchParams((e => Object.keys(e).filter((t => void 0 !== e[t])).reduce(((t, i) => Object.assign(Object.assign(
			{}, t),
			{
				[i]: e[i]
			})),
		...
		}, j = async (e, t, i, o, n, a, s) =>
		{
			...
			var r, c
		}, C = async (e, t, i, o, n, a, s = 1e4) => n ? j(e, t, i, o, s, n, a) : O(e, o, s);
	async function x(e, i)
	{
		var
		{
			...
			auth0Client: r,
			useFormData: c
		} = e, d = t(e, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
		...
		return await async function (e, i, o, n, a, s, r)
		{
			...
			{
				c = await C(e, o, n, a, s, r, i), d = null;
				break
			}
			catch (e)
			{
			...
			if (!f)
			{
				...
				if ("mfa_required" === l) throw new w(l, t, m.mfa_token);
				if ("missing_refresh_token" === l) throw new y(o, n);
	...
	const R = e => "number" == typeof e,
		X = ["iss", "aud", "exp", "nbf", "iat", "jti", "azp", "nonce", "auth_time", "at_hash", "c_hash", "acr", "amr", "sub_jwk", "cnf", "sip_from_tag", "sip_date", "sip_callid", "sip_cseq_num", "sip_via_branch", "orig", "dest", "mky", "events", "toe", "txn", "rph", "sid", "vot", "vtm"],
		D = e =>
		{
	...
	const H = {
		...
		M = {
			...
			save(e, t, i)
			{
				...
				"https:" === window.location.protocol && (o = {
					secure: !0
				}), (null == i ? void 0 : i.daysUntilExpire) && (o.expires = i.daysUntilExpire), (null == i ? void 0 : i.cookieDomain) && (o.domain = i.cookieDomain), J(`_legacy_${e}`, JSON.stringify(t), o), H.save(e, t, i)
			},
			remove(e, t)
			{
				let i = {};
	...
	class ce
	{
		constructor(e)
		{
			...
			if (this.userCache = (new L).enclosedCache, this.defaultOptions = {
				...
				{
					authorizationParams: Object.assign(Object.assign(
					{}, this.defaultOptions.authorizationParams), e.authorizationParams)
		...
		async loginWithPopup(e, t)
		{
			...
			const n = await (e => new Promise(((t, i) =>
			{
				...
				const n = setInterval((() =>
					{
						e.popup && e.popup.closed && (clearInterval(n), clearTimeout(a), window.removeEventListener("message", o, !1), i(new g(e.popup)))
					}), 1e3),
					a = setTimeout((() =>
					{
			...
			if (o.state !== n.state) throw new h("state_mismatch", "Invalid state");
		...
		async loginWithRedirect(e = {})
		{
			...
			const o = se(e),
				...
				l = t(d, ["url"]);
			this.transactionManager.create(Object.assign(Object.assign(Object.assign(
			{}, l),
			{
				appState: s
			}), c &&
		...
		async handleRedirectCallback(e = window.location.href)
		{
			...
			if (!s) throw new h("missing_transaction", "Invalid state");
			if (this.transactionManager.remove(), n) throw new p(n, a || n, i, s.appState);
			if (!s.code_verifier || s.state && s.state !== i) throw new h("state_mismatch", "Invalid state");
		...
		async getTokenSilently(e = {})
		{
			...
			const i = Object.assign(Object.assign(
				...
				{
					authorizationParams: Object.assign(Object.assign(Object.assign(
					{}, this.options.authorizationParams), e.authorizationParams),
					{
		...
		async getTokenWithPopup(e = {}, t = {})
		{
			...
			{}, c), t), await this.loginWithPopup(o, t);
			return (await this.cacheManager.get(new K(
			{
				scope: o.authorizationParams.scope,
				audience: o.authorizationParams.audience || "default",
				clientId: this.options.clientId
		...
		_buildLogoutUrl(e)
		{
			...
			const i = e.logoutParams ||
				...
				n = t(i, ["federated"]),
				a = o ? "&federated" : "";
			return this._url(`/v2/logout?${I(Object.assign({clientId:e.clientId},n))}`) + a
		}
		async logout(e = {})
		{
			const i = se(e),
				...
				n = t(i, ["openUrl"]);
			null === e.clientId ? await this.cacheManager.clear() : await this.cacheManager.clear(e.clientId || this.options.clientId), this.cookieStorage.remove(this.orgHintCookieName,
			{
				cookieDomain: this.options.cookieDomain
			...
			const a = window.location.href;//this._buildLogoutUrl(n);
			o ? await o(a) : !1 !== o && window.location.href//window.location.assign(a)
		}
		async _getTokenFromIFrame(e)
		{
			...
			try
			{
				...
				if (n !== i.state) throw new h("state_mismatch", "Invalid state");
				const u = await this._requestToken(Object.assign(Object.assign(
				{}, e.authorizationParams),
				{
					code_verifier: s,
					code: i.code,
		...
		{
			const t = await this.cacheManager.get(new K(
			{
			...
			try
			{
				const n = await this._requestToken(Object.assign(Object.assign(Object.assign(
				{}, e.authorizationParams),
				{
		...
		async _getIdTokenFromCache()
		{
			const e = this.options.authorizationParams.audience || "default",
				t = await this.cacheManager.getIdToken(new K(
				{
					clientId: this.options.clientId,
					audience: e,
					scope: this.scope
		...
		{
			const o = await this.cacheManager.get(new K(
			{
				scope: e,
				audience: t,
				clientId: i
			...
			if (o && o.access_token)
			{
				const
				{
					...
					oauthTokenScope: t,
					expires_in: i
				} = o, n = await this._getIdTokenFromCache();
		...
		async _requestToken(e, t)
		{
			...
			return await this._saveEntryInCache(Object.assign(Object.assign(Object.assign(Object.assign(
			{}, n),
			{
				decodedToken: a,
				scope: e.scope,
			...
			})), this.cookieStorage.save(this.isAuthenticatedCookieName, !0,
			{
				daysUntilExpire: this.sessionCheckExpiryDays,
				cookieDomain: this.options.cookieDomain
			}), this._processOrgIdHint(a.claims.org_id), Object.assign(Object.assign(
			{}, n),
			{
				decodedToken: a
			})
	...
	e.Auth0Client = ce, e.AuthenticationError = p, e.CacheKey = K, e.GenericError = h, e.InMemoryCache = L, e.LocalStorageCache = E, e.MfaRequiredError = w, e.MissingRefreshTokenError = y, e.PopupCancelledError = g, e.PopupTimeoutError = f, e.TimeoutError = m, e.User = class
