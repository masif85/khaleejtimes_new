...
$msg= Arr::get($_GET, '_refresh', '');
  ...
  if ($lApp) {
    View::render('@base/page/page-gre-survey-app', $page->getViewData());
  } else {
    View::render('@base/page/page-gre-survey', array_replace($page->getViewData(), [
      'tealiumGroup' => 'gresurvey',
		"message"=>$msg
    ]));
  }
