...
if ($currentPage instanceof Page) {
  ...
  $menu = [
	'gold-forex' => 'UAE Draft Rates',
    'bahrain'    => 'Bahrain Draft Rates',
    'qatar'      => 'Qatar Draft Rates'
  ];
  ...
  $goldforexlist = [
    ...
    'uae-fuel'       => '1d956e50-555d-4831-b3ff-d5da325b8a7c'
  ];
  ...
  View::render('@base/page/page-gold-forex', array_replace($page->getViewData(), [
    'articles' => $articles,
