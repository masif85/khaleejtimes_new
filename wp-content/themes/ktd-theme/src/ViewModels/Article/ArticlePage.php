...
class ArticlePage extends Page
{
 ...
 public function render(): void
  {
    $actual_link = strtok(basename($_SERVER['REQUEST_URI']), '?');
   

if($actual_link=='daesh-gets-tougher-in-face-of-air-strikes-claims-leader')
{
  View::render('@base/page/article-page-gallery', $this->getViewData());
}
else
{
    View::render('@base/page/article-page', $this->getViewData());
}
