...
class Teaser extends BaseObject
{
  ...
  public function __construct(PropertyObject $article, string $activeCssClass = "")
  {
    ...
    if (str_contains($activeCssClass, '4_3_image_ratio'))
      $this->ratio = '4:3';
    if (str_contains($activeCssClass, '3_2_image_ratio'))
      $this->ratio = '3:2';
