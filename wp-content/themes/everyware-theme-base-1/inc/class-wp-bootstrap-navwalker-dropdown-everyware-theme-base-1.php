...
if ( ! class_exists( 'Understrap_WP_Bootstrap_Navwalker_Dropdown_everyware_theme_base_1' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Understrap_WP_Bootstrap_Navwalker_Dropdown_everyware_theme_base_1 extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				...
				$atts['class']         = 'nav-link parentlink dropdown-toggle caret';
