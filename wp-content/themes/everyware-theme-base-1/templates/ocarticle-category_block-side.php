<?php
/**
 * Article Name: Category Block - Side
 */
...
if ($article instanceof OcArticle) {
    ...
    $teaserArray['category_block_side_category_display'] = get_theme_mod( 'category_block_side_category_display' );
    $teaserArray['category_block_side_time_diff_display'] = get_theme_mod( 'category_block_side_time_diff_display' );
    $teaserArray['category_block_side_summary_display'] = get_theme_mod( 'category_block_side_summary_display' );
    $teaserArray['category_block_side_author_display'] = get_theme_mod( 'category_block_side_author_display' );
    $teaserArray['category_block_side_time_display'] = get_theme_mod( 'category_block_side_time_display' );
    ...
    View::render('@base/teaser/category-block-side.twig', $teaserArray);
}