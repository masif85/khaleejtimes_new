<?php
/**
 * Article Name: Category Block - Main
 */
...
if ($article instanceof OcArticle) {
    ...
    $teaserArray['category_block_main_category_display'] = get_theme_mod( 'category_block_main_category_display' );
    $teaserArray['category_block_main_time_diff_display'] = get_theme_mod( 'category_block_main_time_diff_display' );
    $teaserArray['category_block_main_summary_display'] = get_theme_mod( 'category_block_main_summary_display' );
    $teaserArray['category_block_main_author_display'] = get_theme_mod( 'category_block_main_author_display' );
    $teaserArray['category_block_main_time_display'] = get_theme_mod( 'category_block_main_time_display' );
    ...
    View::render('@base/teaser/category-block-main.twig', $teaserArray);
}