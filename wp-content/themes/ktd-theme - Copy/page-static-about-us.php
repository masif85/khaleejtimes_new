...
if ($lApp) {
    View::render('@base/page/page-static-about-us-app', array_replace($page->getViewData(), [
      'pagename' => 'aboutus'
    ]));
  } else {
    View::render('@base/page/page-static-about-us', array_replace($page->getViewData(), [
    'tealiumGroup' => 'aboutus',
	'pagename' => 'aboutus'
    ]));
  }
