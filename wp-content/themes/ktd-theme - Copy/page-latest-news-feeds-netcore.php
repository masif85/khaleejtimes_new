...
use KTDTHEME\EuKit\Base\Parts\Image;
header('Content-Type: application/xml; charset=utf-8');
$twigFunctions = new TwigFunctions();

 //$twigFunctions->getImageUrl();
