...
},{"./components/image-upload":2,"./components/json-import-export":3,"./components/oc-query-tester":4,"./components/sortable-list":5,"./jquery/jquery.multi-select.js":6}],2:[function(require,module,exports){
jQuery(function($) {
    $(document).ready( function(e) {
        ...
        ImageUpload.removeImage = function(e) {
            ...
            $placeholder.html('');
            ImageUpload.uploadButton.val('Välj bild');
        };
